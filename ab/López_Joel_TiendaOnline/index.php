...
<body>
    ...
    <header>
        <div class="menu">
            <img class="menu__logo" src="https://i.pinimg.com/550x/2d/26/48/2d2648cc209f6d1a63271937b1366518.jpg"
                alt="Logo">
            <a class="menu__link" href="pages/tienda.html#casa">Casa</a>
            <a class="menu__link" href="pages/tienda.html#jardin">Jardín</a>
            <a class="menu__link" href="#">Contacto</a>
            <a class="menu__link" href="#">¿Quiénes somos?</a>
            <?php
            if ($loginCorrecto) {
    ...
    <main>
        ...
        <section class="collage">
            <article class="collage__article--main">
                ...
                <a class="collage__article--main__link" href="#">Comprar Ahora</a>
            </article>
            ...
            <article class="collage__article">
                ...
                <a class="collage__article__link" href="tienda.html">Comprar ahora</a>
            </article>
        ...
        <section class="brands-container">
            <a class="brands-container__link" href="#">
                <img src="https://upload.wikimedia.org/wikipedia/commons/8/86/Bellota_logo.jpg" alt="">
            </a>
            <a class="brands-container__link" href="#">
            ...
            <section class="favorite">
                ...
                <div class="favorite-grid">
                    <article class="favorite-grid__article">
                        ...
                        <a class="favorite-grid__article__link" href="tienda.html">Comprar ahora</a>
                    </article>
                    ...
                    <article class="favorite-grid__article">
                        <img class="favorite-grid__article__img"
                            src="https://bricoloco.com/cdn/shop/files/FSKMES002_02_KIT_RIEGO_MANGUERA_PISTOLA-600x600.jpg?v=1695106373"
            ...
            <section class="inspiration">
                ...
                <div class="inspiration-grid">
                    <article class="inspiration-grid__article">
                        ...
                        <a class="inspiration-grid__article__link" href="tienda.html">Únete Gratis</a>
                    </article>
                    ...
                    <article class="inspiration-grid__article">
                        ...
                        <a class="inspiration-grid__article__link" href="tienda.html">Comprar ahora</a>
                    </article>
                    ...
                    <article class="inspiration-grid__article">
                        ...
                        <a class="inspiration-grid__article__link" href="tienda.html">Más Información</a>
                    </article>
                </div>
            </section>
    ...
    <footer class="footer">
        ...
        <section class="footer__contact">
            ...
            <form class="footer_contact__form">
